...
const FileViewer: React.FC<FileViewerProps> = ({
  ...
  const detectedType = useMemo(() => {
    ...
    if (["txt", "json", "log", "md", "xml", "js", "ts", "css"].includes(ext))
      return "text";
  ...
  useEffect(() => {
    ...
    if (detectedType === "text" || detectedType === "csv") {
      fetchTextContent();
    } else {
      setIsLoading(false);
    }
                ...
                <div className="flex items-center gap-2 md:gap-4">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className={`p-2.5 rounded-xl transition-all ${isDark ? "hover:bg-white/5 text-white/40 hover:text-emerald-400" : "hover:bg-emerald-50 text-slate-400 hover:text-emerald-600"}`}
                    >
                      <Share2 size={18} />
                    </button>
                    <button
              ...
              <div className="flex-1 overflow-hidden relative flex items-center justify-center p-4 md:p-12">
                ...
                {!isLoading && !error && (
                  ...
                  >
                    ...
                    {detectedType === "csv" && textContent && (
                      <div
                        className={`w-full h-full max-w-7xl rounded-3xl p-4 md:p-8 overflow-auto custom-scrollbar shadow-inner ${
                            ...
                            <tr>
                              {textContent
                                ...
                                .map((h, i) => (
                                  <th
                                    key={i}
                                    className={`p-4 border-b-2 text-xs font-black uppercase tracking-wider ${
                                      isDark
                                  ...
                                  <tr
                                    ...
                                    className={`transition-colors ${
                                      isDark
                                        ...
                                        : "hover:bg-slate-200/50 border-b border-slate-200"
                                    }`}
                                  >
                                    {cells.map((cell, j) => (
                                      <td
                    ...
                    {detectedType === "office" && (
                      <div className="text-center max-w-lg">
                        ...
                        <p className="text-sm font-bold opacity-40 mb-10 leading-relaxed px-10">
                          ...
                          open it using the apps installed on your computer.
                        </p>
