...
const ReceptionLayout: React.FC<ReceptionLayoutProps> = ({
  children,
  pageSpecificShortcuts = [],
}) => {
        ...
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          <div className="relative">
            <button
              ...
              className={`p-3 hover:bg-[#e0e2ec] dark:hover:bg-[#43474e] rounded-full transition-colors relative ${showNotifPopup ? "bg-[#e0e2ec] dark:bg-[#43474e] text-[#1a1c1e] dark:text-[#e3e2e6]" : "text-[#43474e] dark:text-[#c4c7c5]"}`}
            >
              <Bell size={22} />
            </button>
              ...
              {showNotifPopup && (
                ...
                >
                  <div className="px-4 py-3 border-b border-[#e0e2ec] dark:border-[#43474e] flex justify-between items-center">
                    <h3 className="font-bold text-sm text-[#1a1c1e] dark:text-[#e3e2e6]">
                      Notifications
                    </h3>
                    <span className="text-[10px] bg-[#ccebc4] text-[#0c200e] px-2 py-0.5 rounded-full font-bold">
                      0 New
                    </span>
                  </div>
          ...
          <div className="relative" ref={profileRef}>
            <div
              ...
              className={`w-10 h-10 bg-[#ccebc4] dark:bg-[#0c3b10] rounded-full flex items-center justify-center text-[#0c200e] dark:text-[#ccebc4] font-bold border border-[#74777f] dark:border-[#8e918f] ml-1 overflow-hidden cursor-pointer hover:ring-2 ring-[#ccebc4] transition-colors ${showProfilePopup ? "ring-2 ring-[#ccebc4]" : ""}`}
            >
