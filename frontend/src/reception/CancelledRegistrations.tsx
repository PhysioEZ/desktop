...
const CancelledRegistrations: React.FC = () => {
  ...
  const fetchRegistrations = async () => {
    ...
    // Cache logic: Only fetch if empty/null
    if (cancelledRegistrationsCache !== null) {
      setIsLoading(false);
      return;
    }
  ...
  const handleRefresh = async () => {
    ...
    setCancelledRegistrationsCache(null);

    smartRefresh("cancelled registry", {
      onSuccess: async () => {
            ...
            <div className="space-y-8 z-10 text-[#1a1c1e] dark:text-[#e3e2e6]">
              <div className="space-y-3">
                ...
                <p className="text-gray-500 text-sm font-medium leading-relaxed">
                  Financial recovery and refund management.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-8 mb-10">
                ...
                <div className="flex flex-col xl:flex-row items-center justify-between gap-4 p-2">
                  <div className="relative group w-full xl:max-w-md">
                    ...
                    <input
                      type="text"
                      placeholder="Search cancelled patient, phone or ID..."
                      value={search}
              ...
              {isLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="hidden lg:grid grid-cols-[1.5fr_1fr_1fr_1fr_1fr] gap-6 px-10 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 border-b border-black/[0.03] dark:border-white/[0.03] mb-2">
                    <div>Patient</div>
                    <div>Fee</div>
                    <div className="text-center">Refund</div>
                  ...
                  <div className="flex flex-col gap-3 pb-20">
                    {paginatedRegistrations.map((reg: any) => (
                      ...
                      >
                        ...
                        <div className="flex justify-center">
                          {reg.refund_status === "initiated" ? (
                            <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-tight italic opacity-60">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      max={selectedForRefund?.consultation_amount || "0"}
                      required
                  ...
                  <p className="text-[10px] text-rose-500 font-bold mt-3 uppercase tracking-wide">
                    ...
                    {selectedForRefund?.consultation_amount || "0"}
                  </p>
                </div>
