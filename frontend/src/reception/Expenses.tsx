            ...
            <div className="flex justify-between items-end shrink-0">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className={`w-12 h-12 border rounded-2xl flex items-center justify-center transition-all ${isDark ? "bg-[#121212] border-white/5 hover:bg-white/10" : "bg-white border-slate-200 hover:bg-slate-50 shadow-sm"} ${loading || isRefreshing ? "animate-spin" : ""} ${refreshCooldown > 0 ? "opacity-50 cursor-not-allowed" : ""}`}
                >
