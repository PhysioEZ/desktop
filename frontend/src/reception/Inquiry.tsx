...
const Inquiry = () => {
  ...
  const getStatusStyle = (status: string) => {
    ...
    if (s === "visited")
      return "bg-[#ccebc4] text-[#0c200e] border border-[#ccebc4]";
    if (s === "cancelled")
      return "bg-[#ffdad6] text-[#410002] border border-[#ffdad6]";
  ...
  return (
    <ReceptionLayout pageSpecificShortcuts={pageShortcuts}>
      <motion.main
        ...
        initial="hidden"
        animate="visible"
        className="px-4 md:px-8 max-w-[1800px] mx-auto space-y-6 mt-6 pb-20"
      >
        {/* Title & Controls */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-[#43474e] dark:text-[#c4c7c5] mt-1 text-lg transition-colors">
              Track, filter and update patient inquiries
            </p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex items-center gap-3 w-full lg:w-auto">
            <div className="relative flex-1 lg:w-80">
              <Search
                className="absolute left-4 top-1/2 -translate-y-1/2 text-[#43474e] dark:text-[#c4c7c5]"
                size={18}
              />
              <input
        ...
        <motion.div
          ...
          className="bg-[#fdfcff] dark:bg-[#1a1c1e] border border-[#e0e2ec] dark:border-[#43474e] rounded-[28px] overflow-hidden shadow-sm"
        >
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#e0e2ec]/50 dark:bg-[#43474e]/50 border-b border-[#e0e2ec] dark:border-[#43474e]">
                  ...
                  <th className="px-6 py-4 text-xs font-bold text-[#43474e] dark:text-[#c4c7c5] uppercase tracking-wider text-right">
                    Actions
                  </th>
                </tr>
              </thead>
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-20 text-center">
                      <div className="flex flex-col items-center gap-3">
                        ...
                        />
                        <p className="text-sm font-bold text-[#43474e] dark:text-[#c4c7c5]">
                          Loading inquiries...
                        </p>
                      </div>
                    </td>
                      ...
                      >
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 mt-0.5">
                                ...
                                <button
                                  ...
                                  className="text-[10px] text-[#006e1c] dark:text-[#88d99d] font-bold flex items-center gap-1 hover:underline"
                                >
                          ...
                          {activeTab === "consultation" ? (
                            <div>
                              <p className="text-sm font-medium text-[#1a1c1e] dark:text-[#e3e2e6] truncate max-w-[180px]">
                                {options.complaints.find(
                                  (c) => c.value === inquiry.chief_complain,
                                )?.label ||
                                  inquiry.chief_complain ||
                              ...
                              <p className="text-[11px] text-[#43474e] dark:text-[#c4c7c5] mt-0.5">
                                ...
                                {inquiry.referred_by ||
                                  options.sources.find(
                                    (s) => s.value === inquiry.referralSource,
                                  )?.label ||
                            ...
                            <div>
                              <p className="text-sm font-bold text-[#b3261e] dark:text-[#ffb4ab]">
                                {options.tests.find(
                                  (t) => t.value === inquiry.testname,
                                )?.label || inquiry.testname}
                              </p>
                              <p className="text-[11px] text-[#43474e] dark:text-[#c4c7c5] mt-0.5">
                                {inquiry.limb
                                  ? `Limb: ${options.limbs.find((l) => l.value === inquiry.limb)?.label || inquiry.limb}`
                                  : "Standard Study"}
                              </p>
                            </div>
                          )}
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-1">
                            <button
                              onClick={() => handleRegister(inquiry)}
                              className="p-2 text-[#006e1c] dark:text-[#88d99d] hover:bg-[#ccebc4]/20 rounded-full transition-all"
                              title="Convert to Registration"
                            >
                              <UserPlus size={18} />
                            </button>
                            <button
                              onClick={() => openFollowUp(inquiry)}
                              className="p-2 text-[#43474e] dark:text-[#c4c7c5] hover:bg-[#e0e2ec] dark:hover:bg-[#43474e] rounded-full transition-all"
                            ...
                            <button
                              onClick={() =>
                                handleDeleteClick(inquiry.inquiry_id)
                              }
        ...
        <AnimatePresence>
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 text-sm font-medium flex items-center justify-between hover:bg-[#e0e2ec] dark:hover:bg-[#43474e] transition-colors ${
                    menuState.activeValue === opt.value
                      ? "text-[#006e1c] dark:text-[#88d99d] bg-[#ccebc4]/20"
          ...
          {deleteModal.show && (
            <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
              ...
              >
                <h3 className="text-xl font-bold text-[#1a1c1e] dark:text-[#e3e2e6] mb-2">
                  Delete Inquiry?
                </h3>
                ...
                >
                  ...
                  <div className="px-8 py-6 border-b border-[#e0e2ec] dark:border-[#43474e] bg-[#fdfcff] dark:bg-[#1a1c1e] flex items-start justify-between relative overflow-hidden">
                    <div className="relative z-10">
                      <h3
                        className="text-3xl font-black text-[#1a1c1e] dark:text-[#e3e2e6]"
                        style={{ fontFamily: "serif" }}
                      >
                        Follow Up History
                      </h3>
                      <p className="text-sm font-medium text-[#43474e] dark:text-[#c4c7c5] mt-1 flex items-center gap-2">
                        Patient:{" "}
                        <span className="text-[#006e1c] dark:text-[#88d99d] font-bold bg-[#ccebc4]/20 px-2 py-0.5 rounded-md">
                    ...
                    <div className="bg-white dark:bg-[#1e1e20] p-1 rounded-[24px] mb-10 border border-[#e0e2ec] dark:border-[#43474e] shadow-lg">
                      ...
                      <div className="bg-[#f0f4f9] dark:bg-[#111315] p-2 rounded-[20px] flex items-center justify-between mt-2 mx-1 mb-1">
                        <div className="flex items-center gap-2 px-3">
                          <span className="text-[10px] font-black text-[#43474e] dark:text-[#c4c7c5] uppercase tracking-wider">
                            Next Call:
                          </span>
                          <button
                          ...
                          >
                            {nextDate ? (
                              ...
                              <span className="text-[#43474e] dark:text-[#c4c7c5] font-normal">
                                Select Date
                              </span>
                            )}
                            <Calendar
                    ...
                    <div className="relative pb-10">
                      ...
                      {followUpLogs.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-12 opacity-60">
                          ...
                          <p className="text-base font-bold text-[#1a1c1e] dark:text-[#e3e2e6]">
                            No logs yet
                          </p>
                          <p className="text-sm text-[#43474e] dark:text-[#c4c7c5]">
                            Start adding notes to track history.
                          </p>
                        </div>
                      ) : (
                              ...
                              <div className="relative group">
                                <div className="flex items-center gap-3 mb-2">
                                  <div className="flex items-center gap-2 bg-white dark:bg-[#2c2c2e] px-2 py-1 rounded-lg border border-[#e0e2ec] dark:border-[#43474e] shadow-sm">
                                    ...
                                    <span className="text-xs font-bold text-[#1a1c1e] dark:text-[#e3e2e6]">
                                      {log.staff_name || "System"}
                                    </span>
                                  </div>
                                  <span className="text-xs text-[#43474e] dark:text-[#c4c7c5] font-medium">
                                  ...
                                  {log.next_followup_date && (
                                    <div className="mt-3 w-full bg-[#ccebc4]/30 dark:bg-[#0c3b10]/30 px-3 py-2 rounded-xl flex items-center justify-between border border-[#ccebc4] dark:border-[#0c3b10]">
                                      <span className="text-xs font-bold text-[#006e1c] dark:text-[#88d99d] flex items-center gap-2">
                                        <Calendar size={14} /> Scheduled next
                                        call
                                      </span>
