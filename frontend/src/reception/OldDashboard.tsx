            ...
            >
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <motion.button
                            onClick={() => navigate('/reception/material')}
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white rounded-xl shadow-md hover:shadow-lg transition-all font-bold text-xs"
                        >
                            <span className="text-lg">✨</span>
                            <span>Try Material UI</span>
                        </motion.button>
