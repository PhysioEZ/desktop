...
import { 
    ...
    Bell, Moon, Sun, Loader2, RefreshCw, User, LogOut, Clock
} from 'lucide-react';
...
const Patients = () => {
    ...
    const getStatusColors = (status: string) => {
        ...
        switch (s) {
            ...
            case 'completed': return 'bg-[#f0f4f9] text-[#43474e] dark:text-[#c4c7c5] border-[#e0e2ec] dark:border-[#43474e]';
            case 'inactive': return 'bg-[#ffdad6]/30 text-[#93000a] dark:text-[#ffb4ab] border-[#ffdad6] dark:border-[#93000a]';
        ...
        <div className="min-h-screen bg-[#fdfcff] dark:bg-[#111315] text-[#1a1c1e] dark:text-[#e3e2e6] font-sans transition-colors duration-300 pb-20">
            ...
            <div className="max-w-[1600px] mx-auto p-6 pt-44">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                    <div>
                        <h1 className="text-3xl font-black text-[#1a1c1e] dark:text-[#e3e2e6] tracking-tight mb-1" style={{ fontFamily: 'serif' }}>Manage Patients</h1>
                        <p className="text-[#43474e] dark:text-[#c4c7c5] font-medium text-sm">Overview of active cases and treatment tracking</p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                         ...
                         <div className="bg-[#e8def8] dark:bg-[#381e72] rounded-[24px] px-6 py-4 flex flex-col justify-between min-w-[160px] shadow-sm border border-transparent hover:border-[#6750a4]/20 transition-all">
                             <p className="text-[11px] font-bold text-[#1d192b] dark:text-[#eaddff] uppercase tracking-[0.1em] mb-2 opacity-70">New Today</p>
                             <div className="flex items-end justify-between">
                                 <p className="text-3xl font-black text-[#1d192b] dark:text-[#eaddff] tracking-tight">{metaData.counts?.new_today || 0}</p>
                                 <div className="w-8 h-8 rounded-full bg-[#1d192b]/5 dark:bg-white/10 flex items-center justify-center">
                                     <User size={16} className="text-[#1d192b] dark:text-[#eaddff]" />
                                 </div>
                             </div>
                         </div>
                         ...
                         <div className="bg-[#ccebc4] dark:bg-[#0c3b10] rounded-[24px] px-6 py-4 flex flex-col justify-between min-w-[160px] shadow-sm border border-transparent hover:border-[#006e1c]/20 transition-all">
                             <p className="text-[11px] font-bold text-[#0c200e] dark:text-[#ccebc4] uppercase tracking-[0.1em] mb-2 opacity-70">Active Cases</p>
                             <div className="flex items-end justify-between">
                                 <p className="text-3xl font-black text-[#0c200e] dark:text-[#ccebc4] tracking-tight">{metaData.counts?.active_count || 0}</p>
                                 <div className="w-8 h-8 rounded-full bg-[#0c200e]/5 dark:bg-white/10 flex items-center justify-center">
                                     <Stethoscope size={16} className="text-[#0c200e] dark:text-[#ccebc4]" />
                                 </div>
                             </div>
                         </div>
                         ...
                         <div className="bg-[#f2f0f4] dark:bg-[#2b2930] rounded-[24px] px-6 py-4 flex flex-col justify-between min-w-[160px] shadow-sm border border-[#e0e2ec] dark:border-[#43474e] hover:border-[#1a1c1e]/20 transition-all">
                             <p className="text-[11px] font-bold text-[#43474e] dark:text-[#c4c7c5] uppercase tracking-[0.1em] mb-2 opacity-70">Inactive</p>
                             <div className="flex items-end justify-between">
                                 <p className="text-3xl font-black text-[#1a1c1e] dark:text-[#e3e2e6] tracking-tight">{metaData.counts?.inactive_count || 0}</p>
                                 <div className="w-8 h-8 rounded-full bg-[#1a1c1e]/5 dark:bg-white/10 flex items-center justify-center">
                                     <RefreshCw size={16} className="text-[#1a1c1e] dark:text-[#e3e2e6]" />
                                 </div>
                             </div>
                         </div>
                         ...
                         <div className="bg-[#ffdad6] dark:bg-[#93000a] rounded-[24px] px-6 py-4 flex flex-col justify-between min-w-[160px] shadow-sm border border-transparent hover:border-[#ba1a1a]/20 transition-all">
                             <p className="text-[11px] font-bold text-[#410002] dark:text-[#ffdad6] uppercase tracking-[0.1em] mb-2 opacity-70">Completed</p>
                             <div className="flex items-end justify-between">
                                 <p className="text-3xl font-black text-[#410002] dark:text-[#ffdad6] tracking-tight">{metaData.counts?.terminated_count || 0}</p>
                                 <div className="w-8 h-8 rounded-full bg-[#410002]/5 dark:bg-white/10 flex items-center justify-center">
                                     <CheckCircle2 size={16} className="text-[#410002] dark:text-[#ffdad6]" />
                                 </div>
                             </div>
                         </div>
                    </div>
                ...
                <div className="flex flex-col gap-6 mb-8 bg-white dark:bg-[#111315] p-6 rounded-[32px] border border-[#e0e2ec] dark:border-[#43474e] shadow-sm">
                    ...
                    <div className="flex items-center gap-4">
                        <span className="text-sm font-black text-[#74777f] dark:text-[#939099] uppercase tracking-[0.15em] shrink-0">Status:</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4">
                        ...
                        <div className="lg:col-span-12 xl:col-span-5 relative group">
                            <Search className="absolute left-5 top-1/2 -translate-y-1/2 text-[#43474e] dark:text-[#c4c7c5]" size={20} />
                            <input 
                                type="text" 
                        ...
                        <div className="lg:col-span-4 xl:col-span-2">
                             <CustomSelect 
                                ...
                                options={[{label:'Services', value:''}, ...metaData.services.map(s => ({label:s, value:s}))]} 
                                placeholder="Service" 
                                className="!rounded-[28px] !bg-[#f2f0f4] dark:!bg-[#1f1f23] !border-transparent !py-4" 
                            />
                        </div>
                ...
                <div className="flex items-center justify-between px-6 mb-6">
                    <div className="flex items-center gap-2 text-sm text-[#43474e] dark:text-[#c4c7c5] font-medium">
                        ...
                        <span>patients</span>
                        {(filters.search || filters.status || filters.doctor || filters.service_type || filters.treatment) && (
                            <div className="flex items-center gap-1 border-l border-[#e0e2ec] dark:border-[#43474e] ml-2 pl-3">
                                <span>filtered by</span>
                                <div className="flex flex-wrap gap-1">
                                    {filters.search && <span className="bg-[#ccebc4] dark:bg-[#0c3b10] text-[#0c200e] dark:text-[#ccebc4] px-2 py-0.5 rounded-full text-[11px] font-bold">"{filters.search}"</span>}
                                    {filters.status && <span className="bg-[#e8def8] dark:bg-[#381e72] text-[#1d192b] dark:text-[#eaddff] px-2 py-0.5 rounded-full text-[11px] font-bold">{filters.status}</span>}
                                    {filters.doctor && <span className="bg-[#fdfcff] dark:bg-[#2b2930] border border-[#e0e2ec] dark:border-[#43474e] px-2 py-0.5 rounded-full text-[11px] font-bold">Dr. {filters.doctor}</span>}
                                </div>
                                <button 
                                    onClick={() => setFilters({ search: '', status: '', doctor: '', service_type: '', treatment: '' })}
                ...
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-32 bg-slate-50 dark:bg-[#111315] rounded-[40px] border border-dashed border-slate-200 dark:border-slate-800">
                         <div className="w-20 h-20 bg-white dark:bg-slate-800 rounded-3xl shadow-lg flex items-center justify-center mb-6"><Search size={32} className="text-slate-300" /></div>
                         <h3 className="text-xl font-bold text-slate-900 dark:text-white">No patients found</h3>
                         <p className="text-slate-500 mt-2">Adjust your filters or try a different search</p>
                    </div>
                ) : (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-start mb-6">
                                        ...
                                        <div className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border shadow-sm ${getStatusColors(patient.patient_status)}`}>
                                    ...
                                    {/* Patient Info */}
                                    <div className="mb-6">
                                        <h3 className="font-extrabold text-xl text-slate-900 dark:text-white leading-tight mb-1 line-clamp-1 group-hover:text-emerald-600 transition-colors">{patient.patient_name}</h3>
                                        <div className="flex items-center gap-3">
                                            <p className="text-xs font-bold text-slate-500 dark:text-slate-400 flex items-center gap-1"><Phone size={12} /> {patient.patient_phone}</p>
                                            <span className="w-1 h-1 bg-slate-300 rounded-full"></span>
                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">ID: {patient.patient_uid}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4 flex-1">
                                        <div className="p-4 bg-slate-50 dark:bg-[#0b0c0d] rounded-2xl border border-slate-100 dark:border-slate-800/50">
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 px-2 py-0.5 rounded-md uppercase">{patient.treatment_type}</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <Stethoscope size={14} className="text-emerald-500" />
                                                <p className="text-xs font-bold text-slate-700 dark:text-slate-300 line-clamp-1">{patient.service_type || 'General Consultation'}</p>
                                            </div>
                                            <p className="text-[10px] text-slate-400 mt-1 pl-6">Dr. {patient.assigned_doctor}</p>
                                        </div>
                                        ...
                                        <div>
                                            <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-2">
                                                ...
                                                <span className="text-slate-900 dark:text-slate-200">{patient.attendance_count} / {patient.treatment_days} sessions</span>
                                            </div>
                                    ...
                                    <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                                        <div className="flex flex-col">
                                            ...
                                            <p className={`text-lg font-black leading-none ${balance < 0 ? 'text-red-500' : 'text-emerald-600 dark:text-emerald-400'}`}>
                                                ₹{Math.abs(balance).toLocaleString()} 
                                                <span className="text-[10px] ml-1">{balance < 0 ? 'DUE' : ''}</span>
                                            </p>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            <button 
                                                ...
                                                title={!isPresent ? "Mark attendance first" : hasToken ? "Token already printed" : "Print Token"}
                                            >
                                                <Printer size={18} />
                                            </button>
                                            <button 
                                                ...
                                                title={isPending ? "Attendance Pending Approval" : "Mark Attendance"}
                                            >
