...
$BRANCH_FILTERED = [
    'patients', 'registration', 'tests', 'attendance', 'payments',
    'quick_inquiry', 'test_inquiry', 'employees', 'notifications',
    'expenses', 'notes', 'referral_partners',
];
